...
interface RecipeDao {
     ...
     */
    @get:Query("SELECT * FROM recipe WHERE recipe_custom = 0;")
    val allDefaultRecipes: List<Recipe>

    /**
     * Get all recipes in the database that have been saved, and return this result
     */
    @get:Query("SELECT * FROM recipe WHERE recipe_saved = 1;")
     ...
     */
    @get:Query("SELECT Recipe.* FROM recipeingredients\n" +
    ...
    val allRecipesByCheckedIngredients: List<Recipe>
    ...
    fun getAllRecipesByCheckedIngredientsWithLimit(limit: Int): List<Recipe>
    ...
    @Query(" SELECT recipe_ingredients FROM RecipeIngredients\n" +
            ...
            " (SELECT ingredient_name FROM ingredient WHERE ingredient_selected = 1) ;")
    fun getMissingIngredientsByName(name: String): List<String>
    ...
    fun getMissingIngredientsByNameWithLimit(name: String, limit: Int): List<String>
